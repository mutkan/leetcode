package com.mutlucelep.leetcode.utils;
...
public class ProblemFetcher {
  ...
  private static String PACKAGE_BASE = "com.mutlucelep.leetcode";

  public static void main(String[] args) throws IOException {
    String questionUrl = "https://leetcode.com/problems/same-tree/";
